...
uses
  ...
  ExtCtrls, StdCtrls, ExtDlgs, AnimatedGif, MemBitmap , LResources;

type

    { Tfrm_pretty_baby_gif }

  Tfrm_pretty_baby_gif = class(TForm)
    Button1: TButton;
    Button2: TButton;
    Button3: TButton;
    Button4: TButton;
...
var
  frm_pretty_baby_gif: Tfrm_pretty_baby_gif;
...
procedure Tfrm_pretty_baby_gif.AddImage(filename: string; zoom: single);
var w,h: integer;
begin
...
function Tfrm_pretty_baby_gif.GetSelf: TCustomControl;
begin
  result := self;
end;

procedure Tfrm_pretty_baby_gif.FormCreate(Sender: TObject);
...
procedure Tfrm_pretty_baby_gif.Button1Click(Sender: TObject);
var i: integer;
begin
...
procedure Tfrm_pretty_baby_gif.Button2Click(Sender: TObject);
var i: integer;
begin
   for i := 0 to high(gif) do
     gif[i].image.resume;
...
procedure Tfrm_pretty_baby_gif.Button3Click(Sender: TObject);
var i: integer;
begin
   for i := 0 to high(gif) do
...
procedure Tfrm_pretty_baby_gif.Button4Click(Sender: TObject);
var i: integer;
begin
   for i := 0 to high(gif) do
     gif[i].image.CurrentImage:= gif[i].image.CurrentImage+1;
...
procedure Tfrm_pretty_baby_gif.Button5Click(Sender: TObject);
...
procedure Tfrm_pretty_baby_gif.Button6Click(Sender: TObject);
begin
...
procedure Tfrm_pretty_baby_gif.Button7Click(Sender: TObject);
begin
  ResetAnimCanvas;
end;

procedure Tfrm_pretty_baby_gif.ComboBox_ModeChange(Sender: TObject);
var i: integer;
begin
  for i := 0 to high(gif) do gif[i].image.BackgroundMode:= TGifBackgroundMode(Combobox_Mode.ItemIndex);
end;

procedure Tfrm_pretty_baby_gif.FormDestroy(Sender: TObject);
var i: integer;
begin
...
procedure Tfrm_pretty_baby_gif.Panel1Paint(Sender: TObject);
var i: integer;
begin
  UpdateBackground;
...
procedure Tfrm_pretty_baby_gif.PanelMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure Tfrm_pretty_baby_gif.PanelMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
     case drawTool of
     dtBrush:
...
procedure Tfrm_pretty_baby_gif.PanelMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure Tfrm_pretty_baby_gif.IdleTimer1Timer(Sender: TObject);
var i: integer;
begin
...
procedure Tfrm_pretty_baby_gif.UpdateBackground;
...
procedure Tfrm_pretty_baby_gif.ResetAnimCanvas;
begin
  IdleTimer1.Enabled:= false;
  Panel1Paint(self);
end;
